...
def assign_months_to_keys(clean_data_dict):
    months_empty_values = {}
    for date in clean_data_dict.keys():
        month = date[3: 6]
        months_empty_values[month] = []
    return months_empty_values
def assign_monthly_averages(months_empty_values, clean_data_dict):
    monthly_averages = {}
    for date in clean_data_dict.keys():
        month = date[3: 6]
        months_empty_values[month].append(clean_data_dict[date])
...
def print_day_with_record_rainfall(day_with_with_highest_rainfall):
    ...
    print ("\nThe day with record rainfall was {} with {:.2f} inches\n").format(day_with_with_highest_rainfall, str(highest_rainfall * 0.01))
...
def print_average_rainfall_for_month(monthly_averages):
    ...
    if month in monthly_averages:
        ...
        print("The average rainfall for {0} is {1:.2f} inches\n".format(month, monthly_averages_in_inches[month]))
